...
class CreateDefaultSettingsTable extends Command
{
    /** @var string */
    protected $signature = 'model-settings:model-settings-defaults-table';

    /** @var string */
    protected $description = 'Create migration for the default settings table';
    ...
    {
        $table = strtolower(config('model_settings.default_settings_table_name'));
